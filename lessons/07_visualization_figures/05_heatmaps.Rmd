...
#t is to transform data, turn sideways
...
# Loading DDS
load("/scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/carolina/MASTER_CLASS/lessons/05_RNAseq_in_R_studio/Results/dds_time_point_mouse_long.RData", verbose = TRUE)
