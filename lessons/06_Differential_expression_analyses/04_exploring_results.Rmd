...
load("/scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/carolina/MASTER_CLASS/lessons/05_RNAseq_in_R_studio/Results/time_point_res_df.RData")
```
...
#For this filtering steps, we are taking only the significant genes 
...
#basename is average abundance, in here we are asking: from the significantly expressed genes, which ones are highly abundant
...
#Are the genes that are regulated by dox, more abundant than all the genes in the cell? 
