...
view(TPM)
#for the rownames in the TPM put a gene_id column to later remove the gene_id column 
...
hist(TPM_filtered$WT_0_1, xlim = c(0,100), breaks = 1000)
...
```
# Result: 8,687 genes have an average of TPM 1 across all samples.
