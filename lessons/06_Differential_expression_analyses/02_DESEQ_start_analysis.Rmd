...
#Ideas on what to do for leading own project: make plots of what changes if the changes are less or more than 2 fold. Line used to calculate this:  abs(log2FoldChange) > 1)
