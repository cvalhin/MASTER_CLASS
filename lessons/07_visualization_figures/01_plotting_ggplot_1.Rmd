...
#I was getting an error: Error in .Call.graphics(C_palette2, .Call(C_palette2, NULL)) invalid graphics state # I solved it with this command before running the first ggplot line
...
#the thicker 96hour data suggests that the data point, even though they were fewer, they had more variability compared to the other timepoints. 
...
#alpha changes the opacity so we can see all the timepoints, even if they are over each other. 
