...
# Creating a range for hte regions you want to focus on, is good when you want to filter. For example, you can feed R with a bunch of data from different genomes, and with a range, you can ask to focus the data in those ranges instead of the whole genome 
...
ir3
# Once the peaks overlap, what part of the inforamtion do you want. The parts tha overlap or not. 
...
# union (Iranges function): is these two overlap, I am going to take the furthest start and the further end. 
