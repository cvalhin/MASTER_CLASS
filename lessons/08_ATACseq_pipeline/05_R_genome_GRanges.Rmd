...
table(seqnames(gencode_gr))[22] #to see features in chr M total of 153 
# features can be exons, start sites, etc 
...
# To look at all the gene types that are present in that genome 
