...
#to look what types of seqeunces we have in this data 
gencode_gr_mouse@elementMetadata@listData[["type"]]
#to get there, go to the metadata matrix and select the table icon in the right of the 'type' row. This will type the the code line you need to index that colum and for it to be shown. In this case, that line is what is above of this comment.  
