...
#or this command (do not run them last command twice)
...
#taking colnames of countsmatrix and say, are they the same as rownames 
...
#Working directory: /scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/carolina/MASTER_CLASS/lessons/06_Differential_expression_analyses
save(res_df, file = "../05_RNAseq_in_R_studio/Results/time_point_res_df.RData")
# let's also save our DDS
save(dds_time_point, file = "../05_RNAseq_in_R_studio/Results/dds_time_point_mouse_long.RData")
```
